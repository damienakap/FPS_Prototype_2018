...
public class HumanoidBaseScript : MonoBehaviour
{
    ...
    protected WeaponScript[] equippedWeaponScripts = new WeaponScript[weaponCount];
            ...
            if(closestPickup != null)
            {
                ...
                if (playerInput.justPressedE())
                {
                    ...
                    if (equippedWeapons[equippedWeaponIndex])
                    {
                        ...
                        equippedWeapons[equippedWeaponIndex].transform.parent = null;
                        equippedWeapons[equippedWeaponIndex].GetComponents<Collider>()[0].enabled = true;
                        equippedWeapons[equippedWeaponIndex].GetComponents<Rigidbody>()[0].useGravity = true;
                        equippedWeapons[equippedWeaponIndex].GetComponents<Rigidbody>()[0].isKinematic = false;
                    }
                    equippedWeapons[equippedWeaponIndex] = closestPickup;
                    equippedWeapons[equippedWeaponIndex].GetComponents<Collider>()[0].enabled = false;
                    equippedWeapons[equippedWeaponIndex].GetComponents<Rigidbody>()[0].useGravity = false;
                    equippedWeapons[equippedWeaponIndex].GetComponents<Rigidbody>()[0].isKinematic = true;
                    equippedWeaponScripts[equippedWeaponIndex] = closestPickup.GetComponent<WeaponScript>();
    ...
    void AnimationWeaponActions(Animator weaponAnimator, WeaponScript weaponScript)
    {
        if (weaponAnimator != null)
        {
            ...
            if (playerInput.justPressedMouse0() && !fire)
            {
                fire = true;
                shootTimeLast = 0f;
    ...
    void spawnBullet( WeaponScript weaponScript )
    {
    ...
    void equipWeapon( int weaponIndex)
    {
        ...
        if (equippedWeaponAnimators[equippedWeaponIndex] != null && equippedWeaponScripts[equippedWeaponIndex] !=null)
        {
            ...
            //aoc = GameManager.SwapAnimationInState(equippedWeaponAnimators[equippedWeaponIndex], 0, equippedWeaponScripts[equippedWeaponIndex].getIdleAnimation(), null);
            //aoc = GameManager.SwapAnimationInState(equippedWeaponAnimators[equippedWeaponIndex], 1, equippedWeaponScripts[equippedWeaponIndex].getFireAnimation(), aoc);
            //GameManager.SwapAnimationInState(equippedWeaponAnimators[equippedWeaponIndex], 2, equippedWeaponScripts[equippedWeaponIndex].getReloadAnimation(), aoc);
            

            aoc = GameManager.SwapAnimationInState(animator, 22, equippedWeaponScripts[equippedWeaponIndex].getAimDownAnimation(), null);
    ...
    bool getWeaponAnimationAndScript(int weaponIndex)
    {
        ...
        if (equippedWeapons[weaponIndex] != null)
        {
            ...
            equippedWeaponScripts[weaponIndex] = equippedWeapons[weaponIndex].GetComponent<WeaponScript>();
